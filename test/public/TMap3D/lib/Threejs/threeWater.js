...
THREE.Water = function (geometry, options) {
	...
	var eyeCesium = options.eyeCesium !== undefined ? options.eyeCesium : new THREE.Vector3(0, 0, 0);
	...
	var textureMatrixCesium = new THREE.Matrix4();
	...
	var mirrorShader = {
		...
		uniforms: THREE.UniformsUtils.merge([
			...
			THREE.UniformsLib['lights'],
			{
				...
				"textureMatrixCesium": { value: new THREE.Matrix4() },
				"sunColor": { value: new THREE.Color(0x7F7F7F) },
				"sunDirection": { value: new THREE.Vector3(0.70707, 0.70707, 0) },
				"eye": { value: new THREE.Vector3() },
				'eyeCesium': { value: new THREE.Vector3() },
	 ...
	 * @param {THREE.THREE.WebGLRenderTarget|THREE.WebGLRenderTargetCube} renderTarget 
	...
	scope.onBeforeRender = function (renderer, scene, camera) {
		...
		if (renderer.outputEncoding !== THREE.LinearEncoding) {
			...
			console.warn('THREE.Water: WebGLRenderer must use THREE.LinearEncoding as outputEncoding.');
		...
		if (renderer.toneMapping !== THREE.NoToneMapping) {
			...
			console.warn('THREE.Water: WebGLRenderer must use THREE.NoToneMapping as toneMapping.');
			scope.onBeforeRender = function () { };
